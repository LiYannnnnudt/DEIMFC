function [ACC,NMI,JAC,PUR] = MeasureClustering(Target_Clust, Pred_Clust)

    [JAC,PUR] =myClustMeasure(Pred_Clust, Target_Clust);
     ACC = accuracy(Target_Clust, Pred_Clust);
    NMI = nmi(Target_Clust, Pred_Clust);
